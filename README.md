...
Vulkan2D
========
[Vulkan2D](https://github.com/soulwax/Vulkan2D) is a 2D renderer using Vulkan and SDL2 primarily for C games. VK2D aims for an extremely
simple API, requiring no Vulkan experience to use.
...
Documentation
=============
Check out the [documentation website](https://soulwax.github.io/Vulkan2D/index.html).
